...
Hi {}. Welcome to Screenshot Generator Bot. You can use me to generate
    ...
    2. Sample Video.
    3. Trim Video.
    4. Get MediaInfo (Under Developement)
    5. Extract Subtitle (Under Developement)
    
    And many more features coming up.
...
__If issues persists contact my father @vipingupta_1.__"""
